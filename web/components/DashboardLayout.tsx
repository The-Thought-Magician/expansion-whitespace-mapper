  ...
  if (!ready) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-950">
        <span className="inline-block h-6 w-6 animate-spin rounded-full border-2 border-slate-700 border-t-purple-500" />
      </div>
    )
  }
                ...
                return (
                  <Link
                    ...
                    className={`block rounded-lg px-3 py-2 text-sm transition-colors ${
                      active
                        ? 'bg-purple-600/15 font-medium text-purple-200'
